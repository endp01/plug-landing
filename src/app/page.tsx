  ...
  return (
    <>
        ...
        <div className="grid col-span-12 grid-cols-11 lg:grid-cols-10 gap-4 lg:gap-12">
          ...
          <div className="col-span-10 lg:col-span-3">
            ...
            <p className="text-justify text-black/60 dark:text-white/60 ml-10">
              ...
              migrate or deploy a new smart contract.
            </p>
          </div>
      ...
      <form
        ...
        className="flex flex-col lg:flex-row items-center justify-center border-t-[1px] border-black/10 dark:border-white/10 mt-12"
      >
        {!submit && (
          <AnimatePresence>
            <motion.div
